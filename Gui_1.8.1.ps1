...
# Create a label with explanation of the buttons
$label = New-Object System.Windows.Forms.Label
$label.Text = "Explanation:
Disk management: Opens disk management
Firewall: Access the Windows Firewall with Advanced Security console to configure firewall rules and settings
Hyper-V: Creates a BAT file on your desktop to activate Hyper-V. (Tested on win 11 home)
Network Adapters Configuration: Shows Network Adapter Configuration
Password generator: Generates random 14 character password
System Information: Shows information about current machine"
$label.AutoSize = $true
$label.Dock = "Bottom"
